...
//----------------------------------------------------------------------------
void TemplateVC110::GenerateDx9 (const char* projectName)
{
    char prefix[128];
    sprintf_s(prefix, 128, "%sDx9_VC110", projectName);
    Generate(projectName, prefix, msDx9ProjectLines);
}
//----------------------------------------------------------------------------
void TemplateVC110::GenerateWgl (const char* projectName)
{
    char prefix[128];
    sprintf_s(prefix, 128, "%sWgl_VC110", projectName);
    Generate(projectName, prefix, msWglProjectLines);
}
//----------------------------------------------------------------------------
void TemplateVC110::Generate (const char* projectName, const char* prefix,
    char* projectLines[])
{
...
//----------------------------------------------------------------------------
char* TemplateVC110::msDx9ProjectLines[NUM_PROJECT_LINES] =
{
...
//----------------------------------------------------------------------------
char* TemplateVC110::msWglProjectLines[NUM_PROJECT_LINES] =
{
"﻿<?xml version=\"1.0\" encoding=\"utf-8\"?>",
"<Project DefaultTargets=\"Build\" ToolsVersion=\"4.0\" xmlns=\"http://schemas.microsoft.com/developer/msbuild/2003\">",
"  <ItemGroup Label=\"ProjectConfigurations\">",
...
//----------------------------------------------------------------------------
char* TemplateVC110::msFilterLines[NUM_FILTER_LINES] =
{
"﻿<?xml version=\"1.0\" encoding=\"utf-8\"?>",
